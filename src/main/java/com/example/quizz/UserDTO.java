...
public class UserDTO {
    ...
    @NotEmpty(message = "confirm password ne peut être vide.")
    private String confirmParssword;
    ...
    public String getConfirmParssword() {
        return confirmParssword;
    }

    public void setConfirmParssword(String confirmParssword) {
        this.confirmParssword = confirmParssword;
    }
